  ...
  return (
    <SidebarWithHeader>
      ...
      <Flex justify="space-between" align="center" mb={4} flexWrap="wrap">
        <Flex>
          <Tooltip label="Download / Export" aria-label="Download / Export">
            <IconButton
              icon={<FiDownload />}
              colorScheme="blue"
              ...
              {filteredVideos.map((video) => (
                <Tr key={video.video_id}>
                  ...
                  <Td>
                    ...
                    >
                      <a href={video.profile_url} target="_blank" rel="noopener noreferrer">
                        {video.profile_url}
                      </a>
                    </Box>
                  </Td>
                  ...
                  <Td>
                    {new Date(video.live_date).toLocaleDateString()}
                  </Td>
                  <Td>
                    <Badge
                      colorScheme={
                        video.payment_status === "paid"
                          ? "green"
                          : video.payment_status === "pending"
                            ? "yellow"
                            : "red"
                      }
                    >
                      {video.payment_status.charAt(0).toUpperCase() + video.payment_status.slice(1)}
                    </Badge>
                  </Td>
                  <Td isNumeric>{video.brand_price}</Td>
                  <Td isNumeric>{video.commission}</Td>
                  <Td isNumeric>{video.creator_price}</Td>
                  <Td>
                    <Flex>
                      {/* Edit Button */}
                      <IconButton
      ...
      >
        <ModalOverlay />
        <ModalContent bg={bgColor}>
          <ModalHeader>Select Download / Export Options</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <Stack spacing={6}>

...
export const addCreator = async (creatorData, token) => {
  try {
    ...
    throw new Error(
      err.response ? err.response.data.message : "Failed to add creator."
    );
  }
};
...
export const getAllCreators = async (token) => {
  try {
    ...
    throw new Error(
      err.response ? err.response.data.message : "Failed to fetch creators."
    );
  }
};
  ...
  try {
    ...
    throw new Error(
      err.response
        ...
        : "Failed to fetch creator names and URLs."
    );
  }
};
...
export const updateCreator = async (creatorId, updatedData, token) => {
  try {
    const response = await axios.put(
      `${API_URL}/creators/update/${creatorId}`,
      updatedData,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    ...
    throw new Error(
      err.response ? err.response.data.message : "Failed to update creator."
    );
  }
};
